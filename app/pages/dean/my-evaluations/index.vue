  ...
  <div class="space-y-6 pb-10">
        ...
        <div class="flex min-w-0 items-start gap-4">
          ...
          <div class="min-w-0">
            ...
            <p class="mt-2 max-w-3xl text-sm leading-6 text-emerald-50/90">
              Review the faculty evaluations you submitted, including ratings,
              written feedback, and academic-period information.
            </p>
          </div>
        </div>
    ...
    <template v-else>
      ...
      <section class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <div class="rounded-2xl border border-blue-100 bg-blue-50/70 p-5 dark:border-blue-900 dark:bg-blue-950/20">
          <div class="flex items-center justify-between">
            ...
            <div class="flex size-11 items-center justify-center rounded-2xl bg-blue-100 text-blue-600 dark:bg-blue-950 dark:text-blue-400">
              <UIcon
                name="i-lucide-files"
                class="size-5"
              />
        ...
        <div class="rounded-2xl border border-violet-100 bg-violet-50/70 p-5 dark:border-violet-900 dark:bg-violet-950/20">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                Evaluated Faculty
            ...
            <div class="flex size-11 items-center justify-center rounded-2xl bg-violet-100 text-violet-600 dark:bg-violet-950 dark:text-violet-400">
              <UIcon
        ...
        <div class="rounded-2xl border border-amber-100 bg-amber-50/70 p-5 dark:border-amber-900 dark:bg-amber-950/20">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                Academic Periods
            ...
            <div class="flex size-11 items-center justify-center rounded-2xl bg-amber-100 text-amber-600 dark:bg-amber-950 dark:text-amber-400">
              <UIcon
        ...
        <div class="rounded-2xl border border-emerald-100 bg-emerald-50/70 p-5 dark:border-emerald-900 dark:bg-emerald-950/20">
          <div class="flex items-center justify-between">
            <div>
              <p class="text-xs font-medium text-gray-500 dark:text-gray-400">
                Overall Average
            ...
            <div class="flex size-11 items-center justify-center rounded-2xl bg-emerald-100 text-emerald-600 dark:bg-emerald-950 dark:text-emerald-400">
              <UIcon
      ...
      >
        <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-[240px_190px_190px]">
            <UInput
              v-model="searchQuery"
        ...
        <p class="mx-auto mt-2 max-w-md text-sm leading-6 text-gray-500 dark:text-gray-400">
          {{
            records.length
              ...
              : 'Faculty evaluations you submit will appear here.'
          }}
        </p>
      ...
      >
        ...
        >
          <div class="relative overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-violet-950 px-4 py-4 text-white">
            <div class="pointer-events-none absolute -right-10 -top-14 size-36 rounded-full bg-violet-500/20 blur-3xl" />

            <div class="relative flex items-center justify-between gap-3">
              <div class="flex min-w-0 items-center gap-3">
                <div class="flex size-11 shrink-0 items-center justify-center rounded-xl border border-white/15 bg-white/10 font-bold text-violet-300">
                  {{ getFacultyInitials(record) }}
                </div>

                <div class="min-w-0">
                  <p class="text-[9px] font-semibold uppercase tracking-[0.14em] text-violet-300">
                    Dean – Faculty Evaluation
                  </p>
          ...
          <div class="space-y-4 p-4">
            <div class="grid grid-cols-2 gap-2">
              <div class="rounded-xl border border-gray-200 bg-gray-50 px-3 py-2.5 dark:border-gray-800 dark:bg-gray-950/40">
            ...
            >
              <div class="flex items-start gap-2.5">
                <div class="flex size-7 shrink-0 items-center justify-center rounded-lg bg-violet-100 text-violet-600 dark:bg-violet-950 dark:text-violet-400">
                  <UIcon
                ...
                <div class="min-w-0">
                  ...
                  <p class="mt-1 line-clamp-3 whitespace-pre-line text-xs leading-5 text-gray-600 dark:text-gray-400">
    ...
    <UModal v-model:open="detailsOpen">
      <template #content>
        ...
        >
          <div class="relative overflow-hidden rounded-t-[28px] bg-gradient-to-br from-slate-900 via-slate-800 to-violet-950 px-6 py-6 text-white">
            <div class="pointer-events-none absolute -right-16 -top-20 size-52 rounded-full bg-violet-500/20 blur-3xl" />

            <div class="relative flex items-start justify-between gap-4">
              <div class="flex min-w-0 items-center gap-4">
                <div class="flex size-12 shrink-0 items-center justify-center rounded-2xl border border-white/15 bg-white/10 font-bold text-violet-300">
                  {{ getFacultyInitials(selectedRecord) }}
                </div>

                <div class="min-w-0">
                  <p class="text-xs font-semibold uppercase tracking-[0.16em] text-violet-300">
          ...
          <div class="space-y-5 p-6">
            <div class="grid grid-cols-2 gap-3 sm:grid-cols-4">
              ...
              <div class="rounded-xl border border-emerald-100 bg-emerald-50 p-3 dark:border-emerald-900 dark:bg-emerald-950/20">
                <p class="text-[10px] uppercase text-gray-400">
                  Average
                </p>
...
const academicPeriodCount = computed(() => {
  const values = new Set(
...
const filteredRecords = computed(() => {
  ...
  return records.value.filter(record => {
    const facultyName =
      getFacultyName(record).toLowerCase()

    const department =
      getDepartment(record).toLowerCase()
...
const getPrimaryFeedback = (record: any) => {
  return (
    getComment(record) ||
    getStrengths(record) ||
    getEffectiveness(record) ||
    getAreasForImprovement(record) ||
    getSuggestedActivities(record)
  )
}
