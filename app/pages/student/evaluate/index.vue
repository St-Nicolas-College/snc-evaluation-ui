      ...
      >
        ...
        <div class="max-h-[430px] overflow-y-auto p-3">
          ...
          >
            ...
            <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
              No faculty has been assigned to your class for the active academic
              period.
            </p>
...
const getTeachers = async () => {
  ...
  /*
   * Faculty are now managed by the Dean per class.
   *
   * Backend resolution:
   * Logged-in User
   * -> Student
  ...
  teachers.value = assignmentRows
    .map((assignment: any) => {
      ...
      return {
        ...
        /*
         * Existing checkbox UI expects department
         * to be a display string.
         */
        department:
