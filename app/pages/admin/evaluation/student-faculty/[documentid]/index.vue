  ...
  <div class="space-y-5 pb-10">
    ...
    >
      ...
      <section class="report-section">
        ...
        <p class="report-narrative">
          Based on {{ selectedGroup.recordCount }} submitted evaluation
          record{{ selectedGroup.recordCount === 1 ? "" : "s" }}, the selected
          faculty member obtained an overall weighted average of
          <strong>{{ formatNumber(selectedGroup.averageScore) }}</strong>,
          interpreted as
      ...
      <section class="report-section report-page-break-before">
        ...
        <table class="report-standard-table report-criteria-table">
          ...
          <tbody>
            <tr
              v-for="(criterion, criterionIndex) in selectedGroup.criteriaSummary"
      ...
      <section class="report-section report-certification">
        ...
        <p>
          This report was generated from the official Student–Faculty
          Evaluation System and reflects the records available for the stated
          academic period. It is intended solely for authorised institutional
          quality assurance, faculty development, academic review, and related
            ...
            >
              <div class="flex min-w-0 items-center gap-4">
                ...
                <div class="min-w-0">
                  ...
                  <div
                    class="mt-4 grid max-w-xl gap-2 sm:grid-cols-2"
                  >
                    <div
                    ...
                    >
                      <div class="flex items-center gap-2">
                        ...
                        <div class="min-w-0">
                          ...
                          <p
                            class="mt-0.5 truncate text-xs font-bold text-white"
                          >
                ...
                <div class="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                      All ratings, comments, criteria summaries, and AI
                      sentiment results on this page are based on this selected
                      academic period.
                    </p>
              ...
              >
                ...
                >
                  <div class="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                    <div>
                      ...
                      <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        {{ filteredRecordRows.length }} record{{ filteredRecordRows.length === 1 ? "" : "s" }} found.
                      </p>
                    </div>
                ...
                <div class="overflow-x-auto">
                  <table class="w-full min-w-[980px] text-sm">
                    <thead class="bg-gray-50 text-[11px] uppercase tracking-wide text-gray-500 dark:bg-gray-950/40 dark:text-gray-400">
                      <tr>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                      ...
                      >
                        ...
                        <td class="px-4 py-3 text-center">
                          <UBadge :color="ratingColor(record.average_score)" variant="subtle">
                        ...
                        <td class="max-w-[280px] px-4 py-3 text-gray-600 dark:text-gray-400">
                          <p class="truncate" :title="record.comment || 'No comment provided.'">
                ...
                >
                  <p class="text-xs text-gray-500 dark:text-gray-400">
                    Showing
                    {{ filteredRecordRows.length ? (recordPage - 1) * recordPageSize + 1 : 0 }}–
                    {{ Math.min(recordPage * recordPageSize, filteredRecordRows.length) }}
                ...
                >
                  <div class="flex items-start justify-between gap-4 border-b border-gray-200 px-5 py-4 dark:border-gray-800">
                    <div>
                      ...
                      <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        {{ getSemester(selectedEvaluation) }} · {{ getSchoolYear(selectedEvaluation) }} ·
                  ...
                  <div class="space-y-4 p-5">
                    <div class="grid grid-cols-1 gap-3 sm:grid-cols-3">
                      <div class="rounded-xl border border-gray-200 bg-gray-50 p-3 text-center dark:border-gray-800 dark:bg-gray-950/40">
                    ...
                    <section class="overflow-hidden rounded-3xl border border-gray-200/80 bg-white shadow-sm dark:border-gray-800 dark:bg-gray-900">
                      <div class="border-b border-gray-200/80 bg-gradient-to-r from-gray-50 to-white px-5 py-4 dark:border-gray-800 dark:from-gray-950/60 dark:to-gray-900">
                        <h4 class="text-sm font-bold text-gray-900 dark:text-white">Criteria Responses</h4>
                      </div>
                      <div class="overflow-x-auto">
                        <table class="w-full text-sm">
                          <thead class="bg-gray-50 text-xs uppercase text-gray-600 dark:bg-gray-950/40 dark:text-gray-400">
                            <tr>
                              <th class="px-4 py-3 text-left">Criterion</th>
                          ...
                          <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                            ...
                            >
                              <td class="px-4 py-3 text-gray-700 dark:text-gray-300">{{ item.statement }}</td>
                              <td class="px-4 py-3 text-center font-bold text-gray-900 dark:text-white">{{ item.score }}</td>
                            </tr>
                          </tbody>
                        </table>
                      </div>
                    ...
                    <section class="rounded-2xl border border-gray-200 p-4 dark:border-gray-800">
                      <h4 class="text-sm font-bold text-gray-900 dark:text-white">Student Comment</h4>
                      <p class="mt-2 whitespace-pre-line text-sm leading-6 text-gray-600 dark:text-gray-400">
                        {{ selectedEvaluation.comment || "No comment provided." }}
                      </p>
                    </section>

                    <section class="overflow-hidden rounded-2xl border border-violet-100 bg-violet-50/50 dark:border-violet-900 dark:bg-violet-950/20">
                      <div class="border-b border-violet-100 px-4 py-3 dark:border-violet-900">
                      ...
                      <div class="grid gap-3 p-4 sm:grid-cols-2">
                        <div class="rounded-xl bg-white/70 p-3 text-center dark:bg-gray-900/60">
                          <p class="text-xs text-gray-500 dark:text-gray-400">Sentiment</p>
                          <span
                        ...
                        <div class="rounded-xl bg-white/70 p-3 text-center dark:bg-gray-900/60">
                          <p class="text-xs text-gray-500 dark:text-gray-400">Keywords</p>
                          <p class="mt-2 text-sm font-semibold text-gray-800 dark:text-gray-200">
                            {{ formatKeywords(selectedEvaluation.feedback_keywords) }}
                          </p>
                        </div>
                      </div>
                      <div class="border-t border-violet-100 p-4 dark:border-violet-900">
                        <p class="text-xs font-semibold text-gray-500 dark:text-gray-400">AI Summary</p>
                      ...
                      <div class="border-t border-violet-100 p-4 dark:border-violet-900">
                        <p class="text-xs font-semibold text-gray-500 dark:text-gray-400">AI Suggestion</p>
                        <p class="mt-1 whitespace-pre-line text-sm leading-6 text-gray-700 dark:text-gray-300">
                          {{ selectedEvaluation.feedback_sentiment_suggestion || "No AI suggestion available." }}
                        </p>
                      </div>
                    </section>
                  </div>
              ...
              >
                ...
                <div class="space-y-4 p-4">
                  ...
                  >
                    ...
                    <div
                      class="rounded-lg border border-gray-300 bg-gray-50 p-3"
                    >
                      <h4
                        class="text-[10px] font-black uppercase tracking-[0.12em] text-gray-700"
                      >
    ...
    >
      ...
      <p class="mx-auto mt-2 max-w-lg text-sm text-gray-500 dark:text-gray-400">
        No Student–Faculty evaluation records were found for this faculty member.
      </p>
    </div>
  </div>
</template>
...
const hasValidFacultyId = computed(() => {
  ...
  return Boolean(
    value &&
      !["undefined", "null", "unknown-faculty"].includes(value),
  );
});
...
const currentSchoolYearLabel = computed(() => {
  ...
  const groupSchoolYears =
    selectedGroup.value?.schoolYears || [];
  ...
  const addKeywords = (rawKeywords: any) => {
    ...
    values
      ...
      .forEach((keyword) => {
        ...
        keywordCounts.set(
          normalized,
          (keywordCounts.get(normalized) || 0) + 1,
        );
      });
  };
...
const filteredRecordRows = computed(() => {
  ...
  return records.filter((record: any) => {
    ...
    const roundedRating = String(Math.round(Number(record?.average_score || 0)));

    const matchesSearch = !query || label.includes(query) || comment.includes(query);
...
const recordTotalPages = computed(() =>
  Math.max(1, Math.ceil(filteredRecordRows.value.length / recordPageSize.value)),
);
...
const getResults = async () => {
  if (!hasValidFacultyId.value) {
    evaluations.value = [];
    loadError.value =
      "No valid faculty document ID was provided in the URL.";
    pending.value = false;
    return;
  }
  ...
  try {
    const query: Record<string, any> = {
      ...
      "filters[teacher][documentId][$eq]":
        facultyDocumentId.value,
    ...
    if (selectedSemester.value !== "all") {
      query["filters[batch][semester][$eq]"] =
        selectedSemester.value;
    }

    if (selectedSchoolYear.value !== "all") {
      query["filters[batch][school_year][$eq]"] =
        selectedSchoolYear.value;
    }
    ...
    evaluations.value = Array.isArray(response?.data)
      ? response.data
      : [];

    selectedEvaluation.value =
      evaluations.value[0] || null;
  } catch (error: any) {
    console.error(
      "Faculty evaluation summary loading error:",
      error,
    );
...
const createPdfBlob = async (): Promise<Blob> => {
  ...
  const sentiment: any =
    selectedFacultySentimentAnalysis.value;
  ...
  doc.setFontSize(14);
  doc.text(
    "STUDENT–FACULTY EVALUATION REPORT",
    headerCenter,
    y,
    { align: "center" },
  );
  ...
  const ratingRows = [5, 4, 3, 2, 1].map((score) => {
    const frequency =
      Number(group.ratingDistribution?.[score] || 0);
...
const previewPdfReport = async () => {
  ...
  try {
    ...
    toast.add({
      ...
      description:
        error?.message ||
        "The faculty evaluation PDF could not be generated.",
      icon: "i-lucide-triangle-alert",
      color: "error",
    });
  } finally {
...
const getRecordAverage = (record: any) => {
  ...
  return Number.isFinite(storedAverage)
    ? storedAverage
    : 0;
};
