  ...
  <div class="space-y-5 pb-10">
    ...
    >
      <div class="text-center">
        ...
        <p class="mt-3 text-sm text-gray-500 dark:text-gray-400">
          Loading Dean evaluation summary...
        </p>
      </div>
    </div>
    ...
    >
      ...
      <h1 class="mt-3 text-lg font-bold text-red-900 dark:text-red-200">
        Unable to load Dean evaluation summary
      </h1>
            ...
            <div class="min-w-0">
              ...
              >
                ...
                <span class="inline-flex items-center gap-1.5">
                  ...
                  {{ selectedGroup.evaluatorCount }} Faculty Evaluators
                </span>
            ...
            >
              <div class="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Combined strengths submitted by faculty evaluators.
                  </p>
                </div>
              </div>
            ...
            >
              <div class="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Combined recommendations submitted by faculty evaluators.
                  </p>
                </div>
              </div>
          ...
          >
            ...
            >
              <div class="flex items-start gap-3">
                ...
                <div>
                  <h3 class="text-sm font-bold text-gray-900 dark:text-white">
                    Consolidated Faculty Comments
                  </h3>

                  <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                    Written comments submitted for this Dean or Coordinator.
                  </p>
                </div>
              </div>
            </div>

            <div v-if="consolidatedComments.length" class="grid gap-3 p-5 lg:grid-cols-2">
              <article
              ...
              >
                <div class="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    >
                      Consolidated analysis of faculty comments and available
                      AI sentiment results submitted for this Dean or
                      Coordinator.
                    </p>
                  </div>
                </div>
                ...
                <UBadge
                  :color="
                    sentimentColor(
                      selectedDeanSentimentAnalysis.overallSentiment,
                    )
                  "
                  variant="subtle"
                  size="lg"
            ...
            <div class="space-y-5 p-5">
                ...
                >
                  <div class="flex items-center justify-between gap-3">
                    <div>
                      ...
                      >
                        {{ selectedDeanSentimentAnalysis.positive }}
                      </p>

                      <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        {{
                          formatNumber(
                            selectedDeanSentimentAnalysis.positivePercentage,
                          )
                        }}%
                      </p>
                    </div>
                  ...
                  <div class="flex items-center justify-between gap-3">
                    <div>
                      ...
                      <p
                        class="mt-2 text-2xl font-black text-gray-950 dark:text-white"
                      >
                        {{ selectedDeanSentimentAnalysis.neutral }}
                      </p>

                      <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        {{
                          formatNumber(
                            selectedDeanSentimentAnalysis.neutralPercentage,
                          )
                        }}%
                      </p>
                    </div>
                  ...
                  <div class="flex items-center justify-between gap-3">
                    <div>
                      ...
                      <p
                        class="mt-2 text-2xl font-black text-gray-950 dark:text-white"
                      >
                        {{ selectedDeanSentimentAnalysis.negative }}
                      </p>

                      <p class="mt-1 text-xs text-gray-500 dark:text-gray-400">
                        {{
                          formatNumber(
                            selectedDeanSentimentAnalysis.negativePercentage,
                          )
                        }}%
                      </p>
                    </div>
                  ...
                  <div class="flex items-center justify-between gap-3">
                    <div>
                      ...
                      <p
                        class="mt-2 text-2xl font-black text-gray-950 dark:text-white"
                      >
                        {{ selectedDeanSentimentAnalysis.analysedComments }}
                      </p>
              ...
              >
                <div class="p-5">
                  ...
                  >
                    {{ selectedDeanSentimentAnalysis.summary }}
                  </p>

                  <div
                    v-if="selectedDeanSentimentAnalysis.keywords.length"
                    class="mt-4"
                  >
                    <p
                    ...
                    <div class="mt-2 flex flex-wrap gap-2">
                      <UBadge
                        v-for="keyword in selectedDeanSentimentAnalysis.keywords"
                        :key="keyword"
                        color="neutral"
                        variant="subtle"
                      >
                ...
                >
                  ...
                  <ul
                    v-if="selectedDeanSentimentAnalysis.suggestions.length"
                    class="mt-3 space-y-3"
                  >
                    <li
                      v-for="(
                        suggestion, index
                      ) in selectedDeanSentimentAnalysis.suggestions"
                  ...
                  >
                    ...
                    selected Dean or Coordinator.
                  </p>
                </div>
              </div>

              <div
                v-if="!selectedDeanSentimentAnalysis.analysedComments"
          ...
          >
            ...
            <div class="overflow-x-auto">
              <table class="w-full min-w-[980px] text-sm">
                ...
                >
                  <tr>
                    <th class="px-4 py-3 text-left">Faculty Evaluator</th>
    ...
    <UModal
      ...
      id="faculty-dean-evaluation-record-dialog"
      title="Faculty Evaluation Record Details"
      description="View the selected faculty evaluator's scores, comments, strengths, and areas for improvement."
              ...
              <div class="overflow-x-auto">
                <table class="w-full text-sm">
                  ...
                  <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    ...
                    <tr
                      v-if="!formatResponses(selectedEvaluation.responses).length"
                    >
                      <td
                        colspan="3"
    ...
    <UModal
      ...
      id="faculty-dean-evaluation-pdf-preview-dialog"
      title="Faculty–Dean Evaluation PDF Preview"
      description="Preview the official Faculty–Dean evaluation report before downloading or printing the PDF."
          ...
          >
            <div>
              ...
              <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">
                Official Faculty–Dean Evaluation Report
              </p>
            </div>
    ...
    >
      ...
      <h1 class="mt-4 text-lg font-bold text-gray-900 dark:text-white">
        Dean summary not found
      </h1>

      <p class="mx-auto mt-2 max-w-lg text-sm text-gray-500 dark:text-gray-400">
        No Faculty–Dean evaluation records were found for this Dean or
        Coordinator.
      </p>
    </div>
  </div>
...
const hasValidDeanId = computed(() =>
  Boolean(deanDocumentId.value),
);

const selectedSemester = computed(() =>
  String(route.query.semester || "all"),
);
...
const selectedGroup = computed(() => {
  ...
  const deanRecords = evaluations.value.filter(
    (evaluation: any) => {
      const deanId = String(
      ...
      return (
        deanId === deanDocumentId.value ||
        getDeanName(evaluation) === deanDocumentId.value
      );
    },
  );

  if (!deanRecords.length) return null;

  const periodRecords = deanRecords.filter(
    (record: any) => {
  ...
  const records =
    periodRecords.length ? periodRecords : deanRecords;
  ...
  const responseRows = records.flatMap(
    (record: any) => formatResponses(record.responses),
  );
  ...
  scores.forEach((score: number) => {
    if (!isConfiguredRatingScore(score)) {
      return;
    }
  ...
  records.forEach((record: any) => {
    formatResponses(record.responses).forEach(
      (item: any) => {
  ...
  const criteriaSummary = Array.from(
    criteriaMap.values(),
  ).map((criterion: any) => ({
  ...
  const expectedResponses =
    records.length * criteriaSummary.length;
  ...
  return {
    key: deanDocumentId.value,
    name: getDeanName(records[0]),
    department: getDeanDepartment(records[0]),
    ...
    semesters: Array.from(
      new Set(records.map(getSemester)),
    ).filter((value) => value !== "N/A"),
    schoolYears: Array.from(
      new Set(records.map(getSchoolYear)),
    ).filter((value) => value !== "N/A"),
  };
});
...
const currentSemesterLabel = computed(() => {
  ...
  return (
    selectedGroup.value?.semesters?.join(", ") ||
    "All Semesters"
  );
});
...
const currentSchoolYearLabel = computed(() => {
  ...
  return (
    selectedGroup.value?.schoolYears?.join(", ") ||
    "All School Years"
  );
});
...
const reportDocumentCode = "SNC-QA-FDE-001";

const reportSystemReference = computed(() =>
  deanDocumentId.value || "Not available",
);

const reportNumber = computed(() => {
  const deanPart = String(deanDocumentId.value || "REPORT")
    .replace(/[^a-zA-Z0-9]/g, "")
    .slice(-8)
    .toUpperCase();

  return `SNC-FDE-${new Date().getFullYear()}-${deanPart || "REPORT"}`;
});
...
const pdfFileName = computed(() => {
  ...
  return `${deanName}-${semester}-${schoolYear}-Faculty-Dean-Evaluation-Report.pdf`;
});
...
const selectedDeanSentimentAnalysis = computed(() => {
  const records =
    selectedGroup.value?.records || [];
  ...
  records.forEach((record: any) => {
    ...
    if (comment || storedSentiment) {
      ...
      const sentiment =
        normalizeSentiment(storedSentiment);
  ...
  const summary =
    ...
    (analysedComments
      ...
      : "No written faculty feedback or stored AI sentiment result is available for this Dean or Coordinator.");
...
const summaryCards = computed(() => [
  ...
  },
  {
    label: "Completion",
    value: `${formatNumber(
      selectedGroup.value?.completionRate,
    )}%`,
    caption: "Response completeness",
...
const filteredRecordRows = computed(() => {
  ...
  return (selectedGroup.value?.records || []).filter(
    (record: any) => {
      ...
      const nearestRating =
        getNearestRating(average);

      const matchesRating =
        recordRating.value === "all" ||
        String(nearestRating?.score ?? "") ===
          recordRating.value;
...
const recordTotalPages = computed(() =>
  Math.max(
    1,
    Math.ceil(
      filteredRecordRows.value.length /
        Number(recordPageSize.value),
    ),
  ),
);
...
const paginatedRecordRows = computed(() => {
  ...
  return filteredRecordRows.value.slice(
    start,
    start + size,
  );
});
...
const createPdfBlob = async (): Promise<Blob> => {
  ...
  if (!selectedGroup.value) {
    throw new Error("No Faculty–Dean evaluation summary is available.");
  }
  ...
  const sentiment: any = selectedDeanSentimentAnalysis.value;
  ...
  const reportBoxX =
    pageWidth - marginRight - reportBoxWidth;
  const schoolTextLeft =
    marginLeft + logoSize + 8;
  const schoolTextRight = reportBoxX - 7;
  const schoolTextCenter =
    schoolTextLeft +
    (schoolTextRight - schoolTextLeft) / 2;
  ...
  doc.setFontSize(14);
  doc.text(
    "FACULTY–DEAN EVALUATION REPORT",
    headerCenter,
    y,
    { align: "center" },
  );
  ...
  doc.setFontSize(8);
  doc.text(
    "Consolidated leadership performance results, faculty feedback, and AI sentiment analysis",
    headerCenter,
    y,
    { align: "center" },
  );
  ...
  addWrappedParagraph(
    ...
    }, the selected Dean or Coordinator obtained an overall weighted average of ${formatNumber(
      group.averageScore,
  ...
  const ratingRows = ratingScaleDescending.value.map(
    (rating) => {
  ...
  addWrappedParagraph(
    sentiment.summary ||
      "No consolidated AI sentiment summary is available.",
  );
  ...
  addWrappedParagraph(
    "This report was generated from the official Faculty–Dean Evaluation System and reflects the records available for the stated academic period. It is intended solely for authorised institutional quality assurance, leadership development, academic review, and related administrative purposes.",
  );
  ...
  signatureLabels.forEach(
    ([label, role], index) => {
      const x =
        marginLeft +
        index * (signatureWidth + 10);
...
const previewPdfReport = async () => {
  ...
  try {
    ...
    console.error(
      "Faculty–Dean PDF preview generation error:",
      error,
    );

    loadError.value =
      error?.message ||
      "The Faculty–Dean PDF could not be generated.";
  } finally {
...
const downloadPdfReport = async () => {
  ...
  try {
    ...
    console.error(
      "Faculty–Dean PDF download generation error:",
      error,
    );
...
const getResults = async () => {
  ...
  try {
    ...
    if (!selectedGroup.value) {
      loadError.value =
        "No Faculty–Dean evaluation summary was found for the selected Dean or Coordinator.";
    }
  } catch (error: any) {
    evaluations.value = [];
    ...
    loadError.value =
      ...
      error?.data?.message ||
      error?.message ||
      "Failed to load the Faculty–Dean evaluation summary.";
  } finally {
    pending.value = false;
  }
};
...
watch(
  [recordSearch, recordRating, recordPageSize],
  () => {
    recordPage.value = 1;
  },
);
