...
const roleInformation = computed(() => {
  return (
    roleInformationMap[currentRole.value] ||
    roleInformationMap.Student
  )
})
...
const dashboardPageInformation: Record<string, any> = {
  Admin: {
    ...
    description:
      'Monitor evaluation activity and manage the system.',
    icon: 'i-lucide-shield-check'
  },
  ...
  Dean: {
    ...
    description:
      'Review faculty evaluations and departmental performance.',
    icon: 'i-lucide-building-2'
  },
  ...
  Faculty: {
    ...
    description:
      'Review your evaluations and performance insights.',
    icon: 'i-lucide-presentation'
  },
  ...
  Student: {
    ...
    description:
      'Complete and monitor your assigned evaluations.',
    icon: 'i-lucide-graduation-cap'
  }
}
...
const pageInformationMap: Record<string, any> = {
  ...
  '/dean/faculty': {
    ...
    description: 'View faculty members in your department.',
    icon: 'i-lucide-users-round'
  },
  ...
  '/faculty/rank': {
    ...
    description: 'View faculty performance rankings.',
    icon: 'i-lucide-ranking'
  },
...
const currentPage = computed(() => {
  ...
  return {
    title,
    description:
      `${roleInformation.value.label} evaluation portal.`,
    ...
    >
      ...
      >
        ...
        <div class="flex shrink-0 items-center gap-2">
          ...
          <div
            class="mx-1 h-6 w-px bg-gray-200 dark:bg-gray-800"
          />
      ...
      <!-- SCROLLABLE CONTENT -->
      <main
        class="min-w-0 overflow-x-hidden bg-[#f4f8f6] dark:bg-gray-950"
      >
        <div
        ...
        >
          ...
          <div class="relative p-7">
            ...
            <div class="mt-5 text-center">
              ...
              >
                You are about to leave the SNC Evaluation System.
